...
class Player:
    ...
    def select_gesture(self):
        while True:
            self.gesture_select = input("Choose a gesture. Enter 0 for rock, 1 for paper, 2 for scissor, 3 lizard or 4 for spock.")
            if self.gesture_select == "0":
                print(f"You have chosen,{self.gestures[0]}")
            elif self.gesture_select == "1":
